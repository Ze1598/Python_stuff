...
def cardDebt(debt, interest_rate, month_payment):
    ...
    #Get a tuple of the type (first week day of the month, number of days in the month), but only the second item
...
if __name__ == "__main__":
    print(cardDebt(10000, 13, 1000),'\n')
    print(cardDebt(3500, 7, 300), '\n')
    print(cardDebt(75000, 4, 800))