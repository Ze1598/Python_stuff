...
# List of names
boys = ['AFONSO', 'GUSTAVO', 'JOÃO', 'JOSÉ', 'LUCAS', 'MARTIM', 'MIGUEL', 'PEDRO', 'RAFAEL', 'TOMÁS TAVARES', 'TOMÁS TEIXEIRA', 'TOMÁS LOPES', 'ENZO', 'RUI']
girls = ['BIANCA', 'LARA', 'LEONOR FERNANDES', 'LEONOR SILVA', 'MARIA CLARA', 'MATILDE BRANDÃO', 'MATILDE MOREIRA', 'RITA', 'SOFIA','YARA', 'ALICE', 'LUANA','ISOLINA FERNANDA', 'MATILDE FARIA', 'CLÁUDIA', 'FABIANA', 'LARA GOUVEIA', 'LARA MENDES', 'MARIANA SANTOS', 'MARIANA MADEIRA']
